...
function ChatPage({ chatGroupId, userToken }) {
...
const container = document.getElementById("chat_page");
const root = createRoot(container);
root.render(
  <ChatPage chatGroupId={window.chatGroupId} userToken={window.userToken} />
);
